    ...
    public partial class Form1 : Form
    {
        ...
        public void FindLicensePlate2(Bitmap image)
        {
            ...
            if (plate_b != null)
            {
                ...
                pictureBox5.Image = frame_b.ToBitmap();
                pictureBox5.Update();
            }
        ...
        public void FindLicensePlate3(Bitmap image)
        {
            ...
            {
                PlateImagesList.Add(plate_b);
                pictureBox2.Image = frame_b.ToBitmap();
                pictureBox2.Update();
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (temp3 == "")
                textBox1.Text = "Cannot recognize license plate !";
            else
                textBox1.Text = temp3;
        }
